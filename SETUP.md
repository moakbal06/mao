...
```bash
# Option 1: Use sudo
sudo npm install -g @moakbal/mao

# Option 2: Use npx (no global install needed)
npx @moakbal/mao start
...
git clone https://github.com/moakbal06/mao
...
2. Implement the `Tracker` interface from `@moakbal/mao-core`
...
**Need help?** Open an issue at: https://github.com/moakbal06/mao/issues
