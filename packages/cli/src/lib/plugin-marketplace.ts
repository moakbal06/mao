...
import { resolveLocalPluginEntrypoint, type InstalledPluginConfig, type PluginSlot } from "@moakbal/mao-core";
...
export const DEFAULT_REMOTE_MARKETPLACE_REGISTRY_URL =
  "https://raw.githubusercontent.com/moakbal06/mao/main/packages/cli/src/assets/plugin-registry.json";
...
export { normalizeImportedPluginModule } from "@moakbal/mao-core";
